...
function PostCard({ id, image, category, date, title, description }) {
  return (
    <div className="group bg-white border border-gray-100 rounded-3xl overflow-hidden flex flex-col shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-1">
      ...
      <div className="p-6 md:p-8 flex flex-col grow gap-3">
        ...
        <p className="text-[14px] text-[#6c7281] leading-relaxed line-clamp-2 grow">
          {description}
        </p>
        <Link
          to={`/posts/${id}`}
          className="pt-2 flex items-center gap-1.5 text-sm font-bold text-[#5636f3] cursor-pointer group/link"
        >
          <span>Read more</span>
          <svg
